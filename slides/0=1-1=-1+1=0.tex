...
\begin{frame}{$(V_k,\oplus)$-Cobordism Group}
  As an example, consider $\Omega^{V_k,\oplus}_n$, where $V_k=\mathrm{FinVect}^{\cong}_k$ is the category of finite-dimensional vector spaces with all isomorphisms as morphisms. In this case, one can think of a lasagna as a treefold/manifold equipped with a $k$-local system.
  \pause
\begin{itemize}
